	...
	<nav class = "navbar navbar-dark bg-white border border-primary">
        ...
        <div class = "col-8">
            <a href = "<?=base_url()?>home/index" class = "btn btn-outline-primary">Главная</a>
            <a href = "<?=base_url()?>registrations/registration" class = "btn btn-outline-primary">Регистрация</a>    
            <div class = "btn-group" role = "group">
                ...
                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">   
                    <a class="dropdown-item" href="<?=base_url()?>tradings/trading">Торговой точки</a>
                    <a class="dropdown-item" href="<?=base_url()?>group_products/group_product">Группы товара</a>
